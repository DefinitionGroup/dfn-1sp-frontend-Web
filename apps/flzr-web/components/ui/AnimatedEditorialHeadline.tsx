...
export default function AnimatedEditorialHeadline({
  ...
  return (
    <motion.h1
      className="mx-auto max-w-[20ch] text-balance whitespace-pre-line font-flzr text-[clamp(1.9rem,1.4rem+2.6vw,4.25rem)] font-bold italic leading-[1.15] tracking-[-0.025em]"
