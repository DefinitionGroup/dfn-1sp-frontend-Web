            ...
            <div className="col-span-12 col-start-1 iphone-landscape:!col-span-12 iphone-landscape:!col-start-1">
              ...
              >
                {hasVisibleText((staggeredHeader as any)?.title) && (
                  <h2 className="text-section-title text-gray-100 max-w-xl mb-4 pb-8">
            ...
            <header className="col-span-12 px-4 md:px-0 md:col-span-6 col-start-1 iphone-landscape:!col-start-1 iphone-landscape:!col-span-12 md:mt-0">
              <div className="flex flex-col items-start justify-start w-full">
                <div className="flex-1 flex flex-col min-w-0">
                  {header?.superText && (
                    <h4 className=" text-neutral-900 font-bold font-flzr">
                      {header.superText}
                    </h4>
                  )}
                  {hasVisibleText(header?.mainHeadline) && (
                    <h2 className="text-section-title text-gray-900 font-flzr">
                      {header.mainHeadline}
                    </h2>
                  )}
                  {header?.subHeadline && (
                    <h4 className=" text-gray-700 font-medium mt-4  font-flzr">
                      {header.subHeadline}
                    </h4>
                  )}
                </div>
