...
import { getAllCases, getAllServicesForChannel } from "@1sp/sanity-queries";
...
import type { FooterMenu } from "@1sp/sanity-types/menu";
import {
...
/**
 * footer-backup-full — verbatim copy of the full FLZR footer as it shipped
 * before the September 2026 simplification (logo, DEKRA badge, statement,
 * "Start a project" link, cases / services / locations / company columns).
 * Not rendered anywhere. Restore by importing `FlzrFooterFull` in
 * FlzrSiteWrapper in place of `FlzrFooter`.
 */
...
export async function FlzrFooterFull({
  footer,
  language,
  homePage,
}: {
