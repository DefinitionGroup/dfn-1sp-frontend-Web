...
export default function CaseGalleryComponent({
  ...
  const handleViewCaseStudy = (slug: string) => {
    ...
    closeCase();
    setTimeout(() => {
      router.push(localizedPath(`/cases/${slug}`, locale));
    }, 50);
  };
        ...
        {active ? (
          <div className="fixed inset-0  grid place-items-center  w-full  z-[100]">
            ...
            <motion.div
              ...
              ref={ref}
              className="w-[95vw] md:w-full max-w-[960px] min-h-[70vh] max-h-[100vh] grid overflow-hidden rounded-media bg-neutral-900 dark:bg-neutral-900"
            >
              <motion.div
