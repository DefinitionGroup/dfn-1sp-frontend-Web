...
import HeaderImageVideoComp2 from "@renaissance/components/data/Fragments/data-HeaderImageVideoComp2";
import ListContainerComponent from "@renaissance/components/ui/ListContainerComponent";
import ListItemComponent from "@renaissance/components/ui/ListItemComponent";
import CtaMiniComponent from "@renaissance/components/data/Fragments/data-CtaMiniComponent";
...
function ServicesHeroWithBadge({
  ...
  const ctaUrl = localizedPath(renderedCta?.href, locale);
  ...
  return (
    <section
      ...
      className="relative font-renaissance"
      style={{ minHeight }}
    >
