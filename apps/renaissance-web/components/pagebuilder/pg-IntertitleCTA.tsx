...
const IntertitleCTA: React.FC<IntertitleCTAProps> = ({
  ...
  const buttonHref = localizedPath(
    cta?.link ? resolveLink(cta.link) : undefined,
    locale,
  );
    ...
    >
      ...
      >
        <div className="relative border-t border-neutral-900/15 py-16 sm:py-20 lg:py-28">
          <span
            aria-hidden="true"
            className={`mb-8 block h-[3px] w-12 bg-renaissance-accent sm:mb-10 ${isLeftAligned ? "" : "mx-auto"}`}
          />
          <div
