...
import ScrollHighlight from "@renaissance/components/ui/ScrollHighlight";
import ArrowBig from "@renaissance/components/ui/arrowBig";
import CtaMiniComponent from "../Fragments/pg-CtaMiniComponent";
import { TracingBeam } from "@renaissance/components/ui/tracing-beam";
import type {
...
export default function HighlightStep({
  ...
  const cta = (step as any).useCTAMini
    ...
    : null;
  const ctaUrl = localizedPath(cta?.href, locale);
  ...
  return (
    <section
      id={sectionId}
      {...navPointDataAttr}
      className="z-12 mx-auto mt-8 min-h-[60vh] relative bg-neutral-50 font-renaissance text-neutral-600"
    >
