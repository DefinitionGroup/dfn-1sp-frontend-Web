...
export default function CasePoweredByContact({
  ...
  return (
    <section
      className="relative bg-neutral-100 py-16 sm:py-20 lg:py-24 font-renaissance"
    ...
    >
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {relatedPerson && (
          <div
            className="mx-auto mt-14 grid max-w-5xl grid-cols-1 items-end gap-8 overflow-hidden rounded-statement bg-white sm:mt-16 lg:grid-cols-12 lg:gap-10"
          >
