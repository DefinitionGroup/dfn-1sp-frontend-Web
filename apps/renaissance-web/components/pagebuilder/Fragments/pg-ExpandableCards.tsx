        ...
        {active && typeof active === "object" ? (
          <div className="fixed inset-0 flex items-center  justify-center py-8 px-4 md:p-0  z-[100]">
            ...
            <motion.div
              ...
              className="relative flex h-full min-h-[70vh] w-full max-w-[900px] max-h-[600px] flex-col overflow-hidden rounded-media bg-neutral-900 dark:bg-neutral-900 iphone-landscape:min-h-[95vh]"
            >
              {/* Media */} <motion.button
