...
export default function TypewriterRotator({
  ...
  return (
    <h2
      ...
      className={`typewriter-rotator flex flex-col flex-wrap ${isCentered ? "items-center" : "items-start"} w-full font-renaissance leading-[0.8]`}
      style={{ maxWidth: 900 }}
    >
...
const cursorStyle: React.CSSProperties = {
  background: "var(--color-renaissance-accent)",
