    ...
    <div className="fixed top-6 left-0 right-0 z-[1000000] flex h-16 w-full items-center justify-between px-6 md:hidden iphone-landscape:top-2">
      ...
      >
        <Image
          ...
          width={150}
          height={31}
          className="block h-auto w-[150px] object-contain md:hidden"
        />
      </Link>
          ...
          >
            <div className="mb-8 flex items-start justify-between gap-6">
              <div className="flex flex-col text-left text-neutral-100">
                <h2 className="text-2xl md:text-2xl font-renaissance leading-none">
                  Jump into our world
                </h2>
              </div>
              <motion.div
                    ...
                    >
                      {item.subitems.map((sub) => (
                        ...
                        >
                          <Link
                            href={sub.href}
                            className="text-sm text-white hover:text-violet-200  py-2  transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-violet-400"
            ...
            >
              <div className="flex items-center justify-between text-neutral-100">
                ...
                <span className="text-xs text-neutral-300">
                  Copyright {new Date().getFullYear()} Renaissance
                </span>
              </div>
