...
type EuropeanLocationDefinition = Omit<RenaissanceEuropeanLocation, "name"> & {
  names: Record<RenaissanceLocationLocale, string>;
};
...
function normalizeLocale(locale?: string): RenaissanceLocationLocale {
  return locale === "de" || locale === "pl" ? locale : "en";
}

export function getRenaissanceEuropeanLocations(
  locale?: string,
): RenaissanceEuropeanLocation[] {
...
export function getRenaissanceGlobeSectionId(sectionTitle?: string): string {
