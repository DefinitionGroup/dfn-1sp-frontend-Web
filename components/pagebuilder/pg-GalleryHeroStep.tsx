  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 container mx-auto px-4  sm:px-6 lg:px-8 font-aspekta">
        ...
        <div className="grid grid-cols-12 sm:grid-cols-6 md:grid-cols-12 gap-4 sm:gap-6 lg:gap-8 pt-16 sm:pt-24 lg:pt-32 pb-6 sm:pb-8 lg:pb-12">
          {/* Badge - Responsive positioning */}
          {step.badge && (
            <div className="col-span-4 sm:col-span-3 iphone-landscape:col-span-12  md:col-span-2 mb-6 md:mb-0">
              <Badgemodule
          ...
          {/* Main Content */}
          <div className={`col-span-4 iphone-landscape:col-span-12 sm:col-span-6 ${step.badge ? "md:col-span-10 md:col-start-3" : "md:col-span-12"}`}>
            {step.typewriterText && (
