          ...
          <div className="z-1 col-span-12 md:col-span-10 lg:col-span-8 col-start-1">
            <div className="flex flex-col items-start gap-4 sm:gap-6 lg:gap-8 justify-center w-full">
              <StaggeredSlideUp
                ...
                staggerDelay={0.03}
                distance={100}
                className="max-w-full md:max-w-2/3 lg:max-w-2/4 py-16 sm:py-24 lg:py-32"
              >
                <h2 className="text-sm sm:text-base lg:text-lg leading-none text-neutral-700 pb-2 sm:pb-3 font-aspekta">
                  {headline}
                </h2>
                <h3 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl text-neutral-700 leading-tight sm:leading-tight lg:leading-[60px] font-aspekta">
                  {title}
                </h3>
                {description && (
                  <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl text-neutral-300 pb-2 sm:pb-3 leading-tight sm:leading-tight lg:leading-[60px] font-aspekta">
                    {description}
                  </h2>
                )}
              </StaggeredSlideUp>
