...
const buttonVariants = {
  ...
  violet:
    "bg-[#afff40] text-[#121212] hover:bg-violet-300 active:bg-violet-500",
  outline:
...
export default function Button({
  ...
  const baseClasses =
    "relative inline-flex items-center justify-between font-['plecnik_Variable'] font-normal leading-[1.45] transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-[#f4f4f4] focus:ring-offset-2 focus:ring-offset-[#121212] disabled:opacity-50 disabled:cursor-not-allowed";
