...
Current repository guide, checked 2026-09-20. Pages use `content[]`; schema definitions live under `packages/sanity-schema/src`. The [original single-site guide](archive/guides/pagebuilder-guide-original.md) is retained only as history.
