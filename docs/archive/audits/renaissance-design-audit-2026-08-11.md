> Historical reference, classified 2026-09-20. Findings, commands, branches and dataset assumptions below describe an earlier state. Re-verify before reuse. Start with [current documentation](../../README.md).
...
![Desktop hero](../../../apps/renaissance-web/audits/2026-08-11/01-desktop-hero.png)
...
![Desktop story stage](../../../apps/renaissance-web/audits/2026-08-11/02-desktop-stories.png)

![Mobile story stage](../../../apps/renaissance-web/audits/2026-08-11/08-mobile-stories.png)
...
![Desktop services](../../../apps/renaissance-web/audits/2026-08-11/03-desktop-services.png)

![Mobile services](../../../apps/renaissance-web/audits/2026-08-11/09-mobile-services.png)
...
![People and origin](../../../apps/renaissance-web/audits/2026-08-11/04-desktop-people-origin.png)

![Mobile people and origin](../../../apps/renaissance-web/audits/2026-08-11/10-mobile-people.png)
...
![Mobile global reach](../../../apps/renaissance-web/audits/2026-08-11/11-mobile-global.png)

![Mobile contact](../../../apps/renaissance-web/audits/2026-08-11/12-mobile-contact.png)
...
![Mobile menu](../../../apps/renaissance-web/audits/2026-08-11/07-mobile-menu.png)

![Mobile footer](../../../apps/renaissance-web/audits/2026-08-11/13-mobile-footer.png)
...
- **Recommendation:** enforce the support tiers in [design-system/COMPONENTS.md](../../../apps/renaissance-web/design-system/COMPONENTS.md) in Studio previews and validation. A registered block is not automatically an approved Renaissance pattern.
...
- Foundations and design rules: [DESIGN.md](../../../apps/renaissance-web/DESIGN.md)
- Approved components and Pagebuilder tiers: [design-system/COMPONENTS.md](../../../apps/renaissance-web/design-system/COMPONENTS.md)
- Working method and ownership: [design-system/README.md](../../../apps/renaissance-web/design-system/README.md)
- Definition of done: [design-system/RELEASE-CHECKLIST.md](../../../apps/renaissance-web/design-system/RELEASE-CHECKLIST.md)
