...
> **What's new vs. `docs/templates/new-multisite-project.md`:**
...
>
> If you've read `docs/templates/new-multisite-project.md`, much of this is the same. Differences are marked
...
linearly. Drop into a fresh repo as `docs/templates/new-multisite-project.md` (or AGENTS.md / CLAUDE.MD)
...
The structure is identical to v1 of this recipe (see `docs/templates/new-multisite-project.md` if you
...
Identical to v1. See `docs/templates/new-multisite-project.md` sections 5.2–5.4.
